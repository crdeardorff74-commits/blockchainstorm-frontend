        ...
        function promptForName(scoreData) {
            ...
            const handleSubmit = async () => {
                ...
                await submitNamedScore(name, scoreData);
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (e.key === 'ArrowUp') {
                ...
                e.preventDefault();
                // Start game with currently displayed mode
                startGame(currentLeaderboardMode);
            }
        });
        ...
        async function submitScore(gameData) {
            const scoreData = {
                ...
                difficulty: gameMode || 'downpour',
                mode: 'normal', // or 'challenge' if challenge mode enabled
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (isAnonymous && result.message && result.message.includes('register')) {
                        // Prompt user to register to save score
                    ...
                    if (cell !== null) {
                        ...
                        if (hitBlob) {
                            ...
                            if (canLiftBlob(hitBlob)) {
                                ...
                                playSoundEffect('rotate'); // Pickup sound
                            } else {
                                ...
                                playSoundEffect('rotate'); // Disintegrate sound
        ...
        function triggerUFO() {
            ...
            playSoundEffect('special'); // Use special sound for UFO
        }
        ...
        function triggerBouncePiece() {
            ...
            playSoundEffect('drop'); // Play bounce sound
        ...
        function clearLines() {
            ...
            if (completedRows.length > 0) {
                ...
                if (isStrike) {
                    ...
                    canvas.classList.add('blackhole-active');
                    playEnhancedThunder(); // Dramatic sound
                    setTimeout(() => {
                        canvas.classList.remove('blackhole-active');
                    }, 1000);
        ...
        function hardDrop() {
            ...
            playSoundEffect('move'); // Initial sound
        }
