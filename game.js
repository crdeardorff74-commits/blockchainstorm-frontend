    ...
    <style>
        * {
        ...
        .game-container {
            ...
            gap: 1.5vw; /* Add proper gap between panels */
            position: relative;
            z-index: 1;
            height: 100%;
            max-height: 85vh;
        ...
        #touchControls {
            ...
            padding: 0.5vh;
            margin-top: 2.1vh; /* Decreased slightly from 2.35vh */
            height: auto;
            max-height: 24vh;
        }
        ...
        body:has(canvas.thicker-mode) .game-container {
            gap: 1.5vw; /* Consistent gap with normal mode */
        ...
        /* When leaderboard is shown, position it properly */
        #leaderboardDisplay {
            background: rgba(30, 60, 120, 0.35);
            padding: 2vh 1.5vw;
            border-radius: 1vh;
        ...
        <div class="rules-panel">
            <div class="rules-instructions">
                ...
                <div class="rules-section">
                    ...
                    <br><br>
                    <strong>🌋 Volcano:</strong> When a blob touching any edge is completely surrounded by another blob, it turns to lava, erupting upward and raining down as single blocks. Lava blocks combine like normal colors. Each lava segment cleared multiplies the line clear by 2<sup>n</sup> (1 segment = 2×, 2 segments = 4×, 3 segments = 8×)!
                    <br><br>
