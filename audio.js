...
const gameplaySongs = [
    ...
    { id: 'you_say_tornado_country_redux', name: 'You Say Tornado (Country Redux)', file: MUSIC_BASE_URL + 'You.Say.Tornado.Country.Redux.mp3' },
    ...
    { id: 'you_say_tornado_edm_redux', name: 'You Say Tornado (EDM Redux)', file: MUSIC_BASE_URL + 'You.Say.Tornado.EDM.Redux.mp3' },
    ...
    { id: 'you_say_tornado_reggae_redux', name: 'You Say Tornado (Reggae Redux)', file: MUSIC_BASE_URL + 'You.Say.Tornado.Reggae.Redux.mp3' },
